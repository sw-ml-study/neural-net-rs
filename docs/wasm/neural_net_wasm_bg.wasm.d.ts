...
export const neuralnetwork_new: (a: number, b: number, c: number, d: number, e: bigint) => [number, number, number];
export const neuralnetwork_fromExample: (a: number, b: number, c: number, d: number, e: bigint) => [number, number, number];
...
export const getExampleData: (a: number, b: number) => [number, number, number];
